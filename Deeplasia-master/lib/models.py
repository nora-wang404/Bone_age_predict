...
class BoneAgeModel(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        # 添加RMSE相关的标量图
        self.logger.experiment.add_scalars(
            "Metrics_Age/RMSE_months",
            {"val": log_dict["Metrics_Age/val_MeanSquaredError"]},
            global_step=self.current_epoch,
        )
        ...
        # 添加RMSE的日志记录
        self.log("Step-wise/val_rmse", log_dict["Metrics_Age/val_MeanSquaredError"])
        self.log("Step-wise/val_reg_rmse", log_dict["Metrics_Age_Reg/val_reg_MeanSquaredError"])

        self.log("Step-wise/val_ROC", log_dict["Metrics_Sex/val_AUROC"])
        print(f"mad:{log_dict['Metrics_Age/val_RescaledMAE']} , rmse:{log_dict['Metrics_Age/val_MeanSquaredError']}")
        print(f"reg_mad:{log_dict['Metrics_Age_Reg/val_reg_RescaledMAE']} , reg_rmse:{log_dict['Metrics_Age_Reg/val_reg_MeanSquaredError']}")
